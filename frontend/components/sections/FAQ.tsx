      ...
      <div className="mx-auto max-w-[1440px] px-5 py-[50px] sm:px-8 sm:py-16 lg:px-10 lg:py-20 xl:px-10">
        ...
        <div className="grid gap-10 lg:grid-cols-[38%_60%]">
          ...
          <div className="lg:sticky lg:top-28 lg:self-start">
            ...
            <p className="mt-5 max-w-md text-[0.95rem] leading-[1.9] text-[#A7A7A7]">
              {description}
            </p>
          ...
          <div className="space-y-4">
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  key={faq.question}
                  className="overflow-hidden rounded-[20px] border border-[#262626] bg-[#050505] transition-all duration-300 hover:border-[#51FF73]"
                >
                  ...
                  >
                    ...
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#262626] text-[#51FF73]">
                  ...
                  >
                    ...
                    <div className="overflow-hidden">
                      ...
                      <p className="px-6 pb-6 text-[0.9rem] leading-[1.9] text-[#A7A7A7]">
                        {faq.answer}
                      </p>
