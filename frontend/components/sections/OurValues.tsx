        ...
        <div className="mt-8 grid grid-cols-2 gap-3 sm:mt-10 sm:gap-4 md:grid-cols-3 lg:grid-cols-5 lg:gap-5">
          ...
          {values.map(({ icon: Icon, title, description }) => (
            ...
            >
              ...
              <div className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-[var(--primary)] text-[var(--primary)] sm:h-12 sm:w-12">
              ...
              <p className="relative mt-2 text-[0.72rem] leading-[1.6] text-[var(--text-body)] sm:mt-3 sm:text-[0.8rem] sm:leading-[1.8]">
                {description}
              </p>
