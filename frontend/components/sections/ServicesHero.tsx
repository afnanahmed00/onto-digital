    ...
    <section className="bg-black">
      <div className="mx-auto flex max-w-[1440px] flex-col items-center px-5 pt-28 pb-12 text-center sm:px-8 sm:pt-28 sm:pb-14 lg:px-10 lg:pt-40 lg:pb-16 xl:px-10">
        ...
        <div className="mt-8 flex w-full flex-col items-center gap-4 sm:w-auto sm:flex-row sm:gap-8">
          <Link
            href="/contact"
            className="group flex h-[45px] w-full items-center justify-center gap-3 rounded-xl border border-[#51FF73] px-7 font-heading text-[0.8rem] font-medium uppercase tracking-[0.08em] transition-all duration-300 hover:bg-[#51FF73] hover:text-black sm:w-auto"
          >
            <ArrowUpRight
              size={16}
          ...
          <Link
            href="/projects"
            className="group inline-flex items-center gap-3 font-heading text-[0.8rem] font-medium uppercase tracking-[0.15em] text-white transition-colors duration-300 hover:text-[#51FF73]"
          >
            VIEW OUR WORK
