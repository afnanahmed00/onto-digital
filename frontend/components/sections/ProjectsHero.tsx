export default function ProjectsHero() {
  return (
    <section className="relative overflow-hidden bg-[var(--background)]">
      ...
      <div
        className="pointer-events-none absolute left-1/2 top-0 h-[360px] w-[720px] -translate-x-1/2 -translate-y-1/3 rounded-full bg-[var(--primary)]/10 blur-[110px] sm:h-[420px] sm:w-[820px]"
        aria-hidden="true"
      />
