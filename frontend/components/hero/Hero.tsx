...
export default function Hero() {
  return (
    <section className="relative w-full overflow-hidden bg-[var(--background)]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[80vh] w-full max-w-[1440px] flex-col justify-center pt-28 pb-12 px-5 sm:min-h-[80vh] sm:px-8 sm:pt-28 sm:pb-16 lg:min-h-screen lg:flex-row lg:items-center lg:justify-between lg:px-10 lg:pt-24 lg:pb-12 xl:px-10">
