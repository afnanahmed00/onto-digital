...
/**
 * Branded 404 for /services/[slug]. Mirrors app/not-found.tsx exactly: a
 * dynamic route only gets a real 404 status (instead of notFound() bubbling
 * to the root boundary but the already-streamed response staying 200) when
 * a not-found.tsx is colocated in the same route segment.
 */
